...
window.onload = function() {
  ...
  const form = getObjectWithExpectedType(() => document.getElementById('controller'), HTMLFormElement)
  ...
  entities.push(new Ball(300, 100, 0.1, 0))
  // entities.push(new Ball(351, 200, 0.1, 0))
  entities.push(new Wall(50, 0, 100, 300, -1, 0))
  entities.push(new Wall(450, 0, 400, 300, -1, 0))
  draw()

  // Define meta logic
  // =================
  function controllerSubmit(event: Event) {
  ...
  form.addEventListener('submit', controllerSubmit);
}
